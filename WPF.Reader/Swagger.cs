...
//----------------------
// <auto-generated>
//     Generated REST API Client Code Generator v1.6.97.0 on 20/02/2023 10:10:18
...
namespace WPF.Reader.Api
{
    ...
    public interface IBookApiSync : IApiAccessor
    {
        ...
        /// <param name="idGenres"> (optional)</param>
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;BookDTO&gt;</returns>
        List<BookDTO> BookGetBooks(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0);
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        ApiResponse<List<BookDTO>> BookGetBooksWithHttpInfo(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0);
    ...
    public interface IBookApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<List<BookDTO>> BookGetBooksAsync(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// 
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<ApiResponse<List<BookDTO>>> BookGetBooksWithHttpInfoAsync(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class BookApi : IBookApi
    {
        ...
        public WPF.Reader.Client.ApiResponse<Book> BookGetBookWithHttpInfo(int id, int operationIndex = 0)
        {
            ...
            var localVarResponse = this.Client.Get<Book>("/api/book/{id}", localVarRequestOptions, this.Configuration);
        ...
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<Book>> BookGetBookWithHttpInfoAsync(int id, int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            ...
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<Book>("/api/book/{id}", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BookGetBook", localVarResponse);
                if (_exception != null)
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>List&lt;BookDTO&gt;</returns>
        public List<BookDTO> BookGetBooks(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0)
        {
            WPF.Reader.Client.ApiResponse<List<BookDTO>> localVarResponse = BookGetBooksWithHttpInfo(limit, offset, idGenres);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="operationIndex">Index associated with the operation.</param>
        /// <returns>ApiResponse of List&lt;BookDTO&gt;</returns>
        public WPF.Reader.Client.ApiResponse<List<BookDTO>> BookGetBooksWithHttpInfo(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0)
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            if (idGenres != null)
            {
                localVarRequestOptions.QueryParameters.Add(WPF.Reader.Client.ClientUtils.ParameterToMultiMap("multi", "idGenres", idGenres));
            }
            localVarRequestOptions.Operation = "BookApi.BookGetBooks";
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = this.Client.Get<List<BookDTO>>("/api/book", localVarRequestOptions, this.Configuration);
            if (this.ExceptionFactory != null)
            {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of List&lt;BookDTO&gt;</returns>
        public async System.Threading.Tasks.Task<List<BookDTO>> BookGetBooksAsync(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.ApiResponse<List<BookDTO>> localVarResponse = await BookGetBooksWithHttpInfoAsync(limit, offset, idGenres, operationIndex, cancellationToken).ConfigureAwait(false);
            return localVarResponse.Data;
        }
        /// <summary>
        ///  
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (List&lt;BookDTO&gt;)</returns>
        public async System.Threading.Tasks.Task<WPF.Reader.Client.ApiResponse<List<BookDTO>>> BookGetBooksWithHttpInfoAsync(int? limit = default(int?), int? offset = default(int?), List<int> idGenres = default(List<int>), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
            WPF.Reader.Client.RequestOptions localVarRequestOptions = new WPF.Reader.Client.RequestOptions();
            string[] _contentTypes = new string[] {
            };
            ...
            localVarRequestOptions.OperationIndex = operationIndex;
            // make the HTTP request
            var localVarResponse = await this.AsynchronousClient.GetAsync<List<BookDTO>>("/api/book", localVarRequestOptions, this.Configuration, cancellationToken).ConfigureAwait(false);
            if (this.ExceptionFactory != null)
            {
                Exception _exception = this.ExceptionFactory("BookGetBooks", localVarResponse);
                if (_exception != null)
...
namespace WPF.Reader.Model
{
    ...
    public partial class Book : IEquatable<Book>, IValidatableObject
    {
        ...
        public Book(int id = default(int), string title = default(string), int authorId = default(int), Author author = default(Author), float price = default(float), string content = default(string), List<Genre> genres = default(List<Genre>))
        {
            this.Id = id;
...
namespace WPF.Reader.Model
{
    ...
    public partial class BookDTO : IEquatable<BookDTO>, IValidatableObject
    {
        ...
        /// <param name="price">price (required).</param>
        /// <param name="genres">genres.</param>
        public BookDTO(int id = default(int), string title = default(string), string author = default(string), float price = default(float), List<GenreDTO> genres = default(List<GenreDTO>))
        {
            this.Id = id;
            this.Price = price;
            this.Title = title;
